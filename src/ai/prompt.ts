...
export const SYSTEM_INSTRUCTION: string = [
  ...
  "on-screen text.",
  "",
  "Write quoted strings for a HUMAN to read in a ticket. Do NOT add backslashes or any",
  "other escape characters inside them. When you quote a JSON response body, write it as",
  "it appears on the wire, for example: {\"error\":\"tenant_not_found\"} - not with",
